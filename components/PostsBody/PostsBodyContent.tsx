...
const posts = [
    {
        title: 'Stripe',
        description: "To register and log in to BitSwap, you will need an existing BitClout account. If you don't have a BitClout account, you'll have to make one first.",
